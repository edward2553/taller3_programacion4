...
public class App {
    ...
    public App() {
        ...
        String ids[] = {selectLabel, "Cédula de ciudadanía", "Cédula de extranjería", "Pasaporte"};
        idField.addItem(ids[0]);
        idField.addItem(ids[1]);
        idField.addItem(ids[2]);
        idField.addItem(ids[3]);

        String places[] = {selectLabel,"Amazonas", "Antioquia", "Arauca", "Atlántico", "Bogotá", "Bolívar", "Boyacá", "Caldas", "Caquetá", " Chocó"};
...
//                Minimo dos digitos, no incluir numeros ni caracteres especiales
                if (!nameField.getText().matches("[a-zA-ZÀ-úüñ\\s]{2,}")) {
                    hasError = true;
                    nameError.setText("El campo debe contener mínimo dos digitos y no incluir números ni caracteres especiales");
                } else {
                    hasError = false;
                    nameError.setText("");
                }
        ...
        lastnameField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                super.keyTyped(e);
                if (!lastnameField.getText().matches("[a-zA-ZÀ-úüñ\\s]{2,}")) {
                    hasError = true;
                    lastnameError.setText("El campo debe contener mínimo dos digitos y no incluir números ni caracteres especiales");
                } else {
                    hasError = false;
        ...
        idNumberField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!idNumberField.getText().matches("^[0-9]{6,10}$")) {
                    hasError = true;
                    idNumberError.setText("El campo debe contener entre 6 y 10 digitos e incluir solo números");
                } else {
                    hasError = false;
        ...
        phone.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!phone.getText().matches("^[0-9]{10,}$")) {
                    hasError = true;
                    phoneError.setText("El campo debe contener minimo 10 digitos e incluir solo números");
                } else {
                    hasError = false;
                    phoneError.setText("");
                }
        ...
        confirmEmailField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                System.out.println(confirmEmailField.getText());
        ...
        passwordField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!String.valueOf(passwordField.getPassword())
                    ...
                    hasError = true;
                    passwordError.setText("La contraseña debe tener al menos 8 caracteres, una minuscula, una mayuscula y un número");
                } else {
                    hasError = false;
        ...
        confirmPasswordField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!String.valueOf(confirmPasswordField.getPassword())
                    ...
                    hasError = true;
                    confirmPasswrodError.setText("La contraseña debe tener al menos 8 caracteres, una minuscula, una mayuscula y un número");
                } else {
                    hasError = false;
...
//                    hasError = true;
//                    confirmPasswrodError.setText("Las contraseñas deben coincidir");
//                }
...
//                }
                if (hasError) {
                    JOptionPane.showMessageDialog(null,"Revisa el Formulario con los errores");
                }
            }
        });
    }
